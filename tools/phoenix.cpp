...
static string longTxt(u8"它是由从地方到全球范围内几百万个私人的、学术界的、"
...
static string shortTxt(u8"人造卫星能够成功执行预定任务，单凭卫星本身是不行的，"
                       u8"而需要完整的卫星工程系统");

static string oneTxt(u8"它就要背负着积累于人世间的所有不快和仇恨恩怨");

static string bugTxt(u8"，影片讲述了江湖三大高手之一的笑三少遭人陷害亡命天涯并"
                     u8"追查事情真相的故事。");
