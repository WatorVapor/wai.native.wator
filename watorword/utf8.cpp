...
#define HEX_VAR(x) std::cout << __func__ << ":" << __LINE__ << "::" << #x << "=<" << boost::format("0x%02x")%x << ">"<< std::endl;
...
void parseUTF8(const string &article,vector<string> &words,vector<int> &positions)
{
#if 0
