...
void getRawRankPair(const vector<string> &Bytes, map<string, int> &rank,
                    int &minWordSize);
void adjustRankPair(const map<string, int> &rank, map<string, int> &rankAdjust,
                    int minWordSize);

void getRawRank(const vector<string> &Bytes, map<int, vector<string>> &rank,
                int &minWordSize);
void adjustRank(const map<int, vector<string>> &rank,
                map<int, vector<string>> &rankAdjust, int minWordSize);

void dumpRank(const map<int, vector<string>> &rank);
void cutTextByRank(vector<WordElement> &wordVector,
                   const map<string, int> &rank, const string &text);
void cutTextByRank(multimap<int, WordElement> &wordSeq,
                   const map<string, int> &rank, const string &text);

void dumpSeq(const multimap<int, WordElement> &wordSeq);

void getNoConflictSeq(const multimap<int, WordElement> &wordSeq,
                      vector<int> &seq);
void showClearSeq(const string &text, const vector<int> &seq);
void getClearSeq(const multimap<int, WordElement> &wordSeq,
                 const vector<int> &seq,
                 vector<multimap<int, WordElement>> &elemSeq);
void dumpClearSeq(const vector<multimap<int, WordElement>> &elemSeq);

void calcWordPrediction(const vector<multimap<int, WordElement>> &elemSeq,
                        vector<multimap<int, WordElement>> &predSeq);

void showWordPrediction(const string &text,
                        const vector<multimap<int, WordElement>> &predSeq);
...
void calcPrediction(const multimap<int, WordElement> &elemsEntangled,
                    multimap<int, WordElement> &elemsTopSelected) {
...
void calcWordPrediction(const vector<multimap<int, WordElement>> &elemsSeq,
                        vector<multimap<int, WordElement>> &predSeq) {
